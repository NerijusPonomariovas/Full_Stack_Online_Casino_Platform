...
- **Duomenų bazė:** MySQL
- **Sprendimas (Solution):** .NET / C# (`Cataris.sln`)
...
- **Duomenų bazės integracija:** Saugi vartotojų duomenų, balanso ir žaidimų istorijos apskaita.
- **Atsakinga architektūra:** Švari Front-end ir Back-end struktūra paprastam palaikymui ir plėtrai.
...
├── front-end/        # Vartotojo sąsajos kodas ir dizainas
├── mysql/            # Duomenų bazės struktūra ir skriptai
├── Cataris.sln       # Projekto solution failas
