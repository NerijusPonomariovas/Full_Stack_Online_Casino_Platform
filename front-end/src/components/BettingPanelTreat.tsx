...
export default function BettingPanelTreat({ children, betAmount, setBetAmount, startGame, gameOver, gameStarted}: BettingPanelProps) {
    ...
    if (token) {
      const getBalance = async () => {
        ...
        if('balance' in result) {
          ...
          console.log('Account Balance in BettingPanelTreat:', result.balance);
        } else {
